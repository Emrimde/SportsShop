...
public class AddressGetterServiceTest
{
    ...
    public async Task GetAddressById_ReturnCorrectAddress()
    {
        ...
        //Act
        AddressResponse? result = await _addressGetterService.GetAddressById(address.Id, Guid.NewGuid());
    ...
    public async Task GetAddressById_AddressIsNotFound_ToBeNull()
    {
        ...
        // Act
        AddressResponse? result = await _addressGetterService.GetAddressById(missingId, Guid.NewGuid());
